...
class ShowUpdateDamande extends Component
{
    ...
    {
        $this->demande_id = request('damande');
        $this->editing =  Demande::find($id);
    ...
    {
        return [
            'editing.name' => 'nullable|min:2',
            'editing.description' => 'nullable',
            'editing.date_debuit' => 'nullable',
            'editing.date_fin' => 'nullable',
            'editing.lieu' => 'nullable',
            'editing.montant' => 'nullable',
            'editing.payement'=> 'nullable',
            'editing.nombre_jour' => 'nullable',
            'editing.status' => 'nullable',
            'editing.telephone' => 'nullable',
            'editing.is_correct' => 'nullable',
    ...
    {
        return view('livewire.show-update-damande',[
