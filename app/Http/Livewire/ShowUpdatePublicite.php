...
class ShowUpdatePublicite extends Component
{
    ...
    {
        $this->publicite_id = request('publicites');
        $this->editing =  Publication::find($id);
    ...
    public function save()
    {
        ...
        return redirect('/show-publicites');
    }
    public function render()
    {
        return view('livewire.show-update-publicite');
    }
}
