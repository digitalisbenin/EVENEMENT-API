...
class Demande extends Model
{
    ...
    protected $fillable = ['name','priorite','payement','maps', 'description', 'jours', 'date_debuit','date_fin', 'lieu', 'image','video', 'montant', 'nombre_jour','status', 'user_id', 'type_demande_id','is_correct','telephone'];
