...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
        ...
        <tbody>
            @foreach ($publictes as $publicte)
                <tr
                    ...
                    <td class="px-6 py-4">
                        {{ $publicte->description }}
                    </td>
                   
                    <td class="flex items-center px-6 py-4 space-x-3">
                        <a href="#" wire:click="edit({{ $publicte }})" wire:loading.attr="disabled"
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="2xl">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <textarea type="text" rows="4" class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "  placeholder="{{ __('Description') }}"
                    x-ref="editing.description" wire:model.defer="editing.description"></textarea>
