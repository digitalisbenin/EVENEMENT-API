                ...
                <tr
                    ...
                    <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap dark:text-white">
                        @if ($demande->status == 'valider')
                            <span class="text-green-500">{{ $demande->status }}</span>
                        @elseif ($demande->status == 'En attente')
                            <span class="text-yellow-500">{{ $demande->status }}</span>
                        @elseif ($demande->status == 'terminer')
                            <span class="text-red-500">{{ $demande->status }}</span>
                        @else
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3">
                        <a href="#" wire:click="edit({{ $demande }})" wire:loading.attr="disabled"
